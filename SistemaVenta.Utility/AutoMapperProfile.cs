...
namespace SistemaVenta.Utility
{
    public class AutoMapperProfile : Profile
    {
        ...
        {
            #region Rol
            CreateMap<Rol, RolDTO>().ReverseMap(); //mapea de rol a rolDTO y viceversa;
            #endregion Rol
            ...
            CreateMap<UsuarioDTO, Usuario>() //ignora en el destino la propiedad virtual IdRolNavigation ya que el dto no tiene una propiedad que haga match
                .ForMember(destino =>
            ...
            CreateMap<Producto, ProductoDTO>()
                .ForMember(destino =>
                    ...
                    opt => opt.MapFrom(origen => origen.IdCategoriaNavigation.Nombre) // muestra el nombre de la categoria en el campo DescripcionCategoria desde el origen
                )
                .ForMember(destino =>
                    destino.Precio,
